"""Main graph definition for the sales_intelligence_agent_v3 agent."""
...
from sales_intelligence_agent_v3.prompts import get_system_prompt
from sales_intelligence_agent_v3.state import AgentState
from sales_intelligence_agent_v3.tools import get_tools
from sales_intelligence_agent_v3.utils import load_chat_model
...
def main():
    ...
    tools = get_tools()
    print("✅ sales_intelligence_agent_v3 Agent is ready!")
