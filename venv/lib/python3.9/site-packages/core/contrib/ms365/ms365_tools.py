...
def get_ms365_account():
    ...
    account = Account((creds["client_id"], creds["client_secret"]), token_backend_path=TOKEN_PATH)
    ...
    if not account.is_authenticated:
        ...
        account.authenticate(scopes=["User.Read", "Mail.Send", "ChannelMessage.Send", "Team.ReadBasic.All"])
