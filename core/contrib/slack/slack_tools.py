"""
Comprehensive Slack tools for agents.
...
For tools that require searching, like 'slack_get_mentions', you must also provide
a User OAuth Token with the 'search:read' scope, set as `SLACK_USER_TOKEN`.

Required Slack App Scopes for full functionality:
