...
from tools.http_tools import get_http_tools
...
all_tools = get_gworkspace_tools() + get_slack_tools() + get_files_tools() + get_csv_tools() + get_http_tools() + get_execution_tools() + get_code_tools()
